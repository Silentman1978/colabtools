...
def generate_text(prompt: str, model_name='gpt-4o') -> str:
  ...
  client = _OpenAI(
      ...
      # prod or staging.
      base_url='https://mp-staging.kaggle.net',
...
def _get_model_proxy_token() -> str:
  ...
  """
  if 'MODEL_PROXY_TOKEN' in _os.environ:
    return _os.environ['MODEL_PROXY_TOKEN']

  model_proxy_token = _userdata.get('MODEL_PROXY_TOKEN')
  _os.environ['MODEL_PROXY_TOKEN'] = model_proxy_token
